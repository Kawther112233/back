...
const transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: "contact.lahneynekawther@gmail.com",
    pass: "vmet epxv zyhq vihj",
  },
});
// ********************************** REGISTER *****************************
userRouter.post("/register", registerRules(), Validation, async (req, res) => {
  ...
  try {
    ...
    const mailOptions = {
      from: "contact.lahneynekawther@gmail.com",
      to: email,
    ...
    >
      <img
        src="https://i.postimg.cc/9Q8kPK0X/beabea08-967f-4d0e-948e-c3679bc0b402.jpg"
        alt="Your Alt Text"
